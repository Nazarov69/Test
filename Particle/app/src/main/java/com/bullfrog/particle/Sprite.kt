...
class Sprite(context: Context?, attrs: AttributeSet?) :
    ...
    class MainThread(private val surfaceHolder: SurfaceHolder, private val gamePanel: Sprite) :
        Thread() {
    ...
    companion object {
        private val TAG = Sprite::class.java.simpleName
    }

    init {
        holder.addCallback(this)
        elaine = ElaineAnimated(
            BitmapFactory.decodeResource(resources, R.drawable.sprite),
            10,
            50,
            30,
            47,
