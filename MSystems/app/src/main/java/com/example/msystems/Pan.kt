...
class Pan(context: Context?, attrs: AttributeSet?) :
    ...
    class MainThread(private val surfaceHolder: SurfaceHolder, private val gamePanel: Pan) :
        Thread() {
    ...
    companion object {
        private val TAG = Pan::class.java.simpleName
    }

    init {
        holder.addCallback(this)
        elaine = ElaineAnimated(
            BitmapFactory.decodeResource(resources, R.drawable.walk_elaine_back),
            10,
            50,
            30,
            47,
